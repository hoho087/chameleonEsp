...
DWORD MainThread(HMODULE Module)
{
 ...
 //   SDK::APlayerController* MyController = World->OwningGameInstance->LocalPlayers[0]->PlayerController;
	//if (!MyController)
	//{
	//	std::cout << "MyController is nullptr!" << std::endl;
	//	return 1;
	//}

 //   for (SDK::ULocalPlayer* p : World->OwningGameInstance->LocalPlayers)
 //   {
 //       SDK::APlayerController* c = p->PlayerController;
 //       std::cout << "Player ID & Name: " << c->PlayerState->GetPlayerId() << " " << c->PlayerState->GetPlayerName() << std::endl;
 //   }
