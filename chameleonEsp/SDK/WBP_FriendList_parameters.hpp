...
public:
	...
	class UWBP_FriendListContents_C*              CallFunc_Create_ReturnValue;                       // 0x0058(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UOnlineFriendsSubsystem*                CallFunc_GetGameInstanceSubsystem_ReturnValue_2;   // 0x00A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FUniqueNetIdRepl                       K2Node_CustomEvent_Id;                             // 0x00D0(0x0030)(HasGetValueTypeHash)
	class UOnlineFriendRef*                       CallFunc_Array_Get_Item;                           // 0x0100(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_SendSessionInviteToFriend_ReturnValue;    // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FUniqueNetIdRepl                       CallFunc_GetUserId_ReturnValue;                    // 0x0130(0x0030)(HasGetValueTypeHash)
